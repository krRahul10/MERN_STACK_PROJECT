...
export const getUserData = async (search,gender,status,sort) => {
    return await commonRequest("GET",`${BACKEND_URL}/user/details?search=${search}&gender=${gender}&status=${status}&sort=${sort}`,"")
}
